...
public class PostDetails extends AppCompatActivity implements FBReactionsDialog.onReactionListener{
    ...
    public void onReactionSelected(int reactiontype){
        ...
        ReactData react = new ReactData();

        switch (reactiontype){
            case 0:
                react = new ReactData(currentUser.getDisplayName(),"0");
            ...
            case 1:
                ...
                react = new ReactData(currentUser.getDisplayName(),"1");
                reactButton.setIconSize(80);
                reactButton.setIconTint(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                reactButton.setTextColor(getResources().getColor(R.color.primary));
                reactButton.setIconTintMode(PorterDuff.Mode.MULTIPLY);
            ...
            case 2:
                ...
                reactButton.setIconSize(80);
                react = new ReactData(currentUser.getDisplayName(),"2");
                reactButton.setIconTint(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                reactButton.setTextColor(getResources().getColor(R.color.primary));
                reactButton.setIconTintMode(PorterDuff.Mode.MULTIPLY);
            ...
            case 3:
                ...
                reactButton.setIconSize(80);
                react = new ReactData(currentUser.getDisplayName(),"3");
                reactButton.setIconTint(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                reactButton.setTextColor(getResources().getColor(R.color.primary));
                reactButton.setIconTintMode(PorterDuff.Mode.MULTIPLY);
            ...
            case 4:
                ...
                reactButton.setIconSize(80);
                react = new ReactData(currentUser.getDisplayName(),"4");
                reactButton.setIconTint(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                reactButton.setTextColor(getResources().getColor(R.color.primary));
                reactButton.setIconTintMode(PorterDuff.Mode.MULTIPLY);
      ...
      //  DatabaseReference mDatabaseRef = database.getReference();
       ...
       // mDatabaseRef.child("Posts").child("reactID").setValue(react);
        //AddReact(react);
    }
    ...
    private void AddReact(ReactData react) {

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("Reacts").push();

        String key = myRef.getKey();
        react.setReactKey(key);
        react.setPostKey(PostKey);



        myRef.setValue(react).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                showMessage("React Added successfully");
            }
        });
