...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.MyViewHolder>{
    ...
    public interface PostAdapterEvents{
        void postAdapterListener(MyViewHolder holder,int position);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(position == highLightedPos)
        {
            Log.e("High",highLightedPos+" ");
        }
        ...
        Log.e("Local","Data vari: "+this.reactId);

    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public void onReactionSelected(MyViewHolder viewHolder , int position, int reactiontype){
        Log.e("IDD",reactiontype+" ");


         onBindViewHolder(viewHolder,position);

         this.reactId = reactiontype;
         this.highLightedPos = position;
...
/*
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            reactButton = itemView.findViewById(R.id.react_btn);
